...
import com.onestop.wx.mp.model.dto.SubscribeConfigs;
...
@ConditionalOnProperty(prefix = "os.wxmp.subscribe", name = "enabled", havingValue = "true")
public class OsWxmpSubscribeConfiguration {
    @Autowired
    private OsWxmpSubscribeProperties properties;
