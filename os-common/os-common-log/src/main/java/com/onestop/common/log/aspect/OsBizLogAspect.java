...
import com.onestop.common.log.constant.OsLogConsts;
...
public class OsBizLogAspect {
     ...
     * 环绕通知
     */
    @Around("@annotation(com.onestop.common.log.annotation.OsLog)")
    public Object arround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        String name = StrUtil.isNotBlank(osLog.value()) ? osLog.value() : method.getName();
